...
:reproducible:
:imagesoutdir: images
:bibtex-file: server_platform.bib
...
[preface]
include::server_platform_contributors.adoc[]
include::server_platform_intro.adoc[]
include::server_platform_requirements.adoc[]
include::server_platform_bibliography.adoc[]
