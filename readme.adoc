...
RISC-V Server Platform Specification v1.0 is ratified.
The RISC-V Server Platform Test Specification is in development and may change.

See also the Server Platform TG https://github.com/riscv-admin/server-platform/blob/main/charter.adoc[Charter].
