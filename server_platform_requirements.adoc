...
|===
| ID#      ^| Requirement
| `SEC_001`  | MUST implement a hardware root of trust (RoT).
...
| `SEC_002`  | MUST manage a security life cycle.
...
| `SEC_003`  | MUST implement a secure identity and must support platform attestation.
